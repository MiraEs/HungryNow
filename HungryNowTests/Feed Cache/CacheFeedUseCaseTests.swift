...
class LocalMealFeedLoader {
    ...
    func save(_ items: [MealFeedItem], completion: @escaping (Error?) -> Void) {
...
class CacheFeedUseCaseTests: XCTestCase {
    ...
    func test_save_doesNotDeliverDeletionErrorAfterSUTInstanceHasBeenDeallocated() {
        ...
        var sut: LocalMealFeedLoader? = LocalMealFeedLoader(store: store, currentDate: Date.init)
    ...
    private func expect(_ sut: LocalMealFeedLoader, toCompleteWithError expectedError: NSError?, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
